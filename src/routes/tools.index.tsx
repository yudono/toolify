    ...
    <div className="mx-auto w-full max-w-6xl px-5 py-14 sm:py-20">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
          Browse the <span className="text-brand">toolbox</span>
        </h1>
      ...
      <div className="sticky top-20 z-20 mt-8">
        <div className="flex items-center gap-3 rounded-lg border-2 border-foreground bg-surface px-5 py-3 shadow-soft focus-within:ring-2 focus-within:ring-ring/40">
...
function FilterChip({
  ...
  return (
    <button
      onClick={onClick}
      className={`inline-flex items-center gap-2 rounded-sm border-2 border-foreground px-4 py-2 text-sm font-medium transition-all duration-100 ${
        active
